...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/3d_X.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/3d_O.png")';
        }
...
//drawLine() function is called to draw a aline on the screen if the condition is met.
function checkWinConditions() {
    ...
    //O 1, 4, 7 condition.
    else if (arrayIncludes('10', '4O', '7O')) {drawWinLine( 304, 50, 304, 558) }
    //O 0, 5, 8 condition.
...
//placement sound('./media/chess_move.mp3')
